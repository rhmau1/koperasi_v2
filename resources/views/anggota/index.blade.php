                    ...
                    <div class="widget-content widget-content-area">
                        <div class="table-responsive mb-4">
                            @foreach ($dataAkses as $akses)
                                @if ($akses->hak_add == 1)
                                    <a href="{{ route('inputAnggota.create') }}" class="btn btn-primary ml-3 mb-4">+
                                        Tambah
                                        Data</a>
                                @endif
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group">
                                                        <!-- Tombol Edit -->
                                                        @if ($akses->hak_edit == 1)
                                                            <a href="{{ route('inputAnggota.edit', $anggota->id_anggota) }}"
                                                        ...
                                                        @if ($akses->hak_delete == 1)
                                                            <form
                                                                action="{{ route('inputAnggota.delete', $anggota->id_anggota) }}"
                                                                ...
                                                                <button type="submit"
                                                                    ...
                                                                    onclick="return confirm('Apakah Anda yakin ingin menghapus anggota {{ $anggota->nama_anggota }} ini?');"
                                                                    title="Delete">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                        height="16" viewBox="0 0 24 24" fill="none"
                                                                        stroke="currentColor" stroke-width="2"
